...
module "vpc" {
  ...
  app_private_subnets = slice(var.app_private_subnet_cidr_blocks, 0, var.app_private_subnet_count)
  data_private_subnets = slice(var.data_private_subnet_cidr_blocks, 0, var.data_private_subnet_count)
